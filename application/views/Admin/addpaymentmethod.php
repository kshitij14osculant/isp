...
<body id="page-top">
  ...
  <div class="form-row" style="margin-top: 15px; margin: 10px">
    <div class="form-group col-md-12">
      ...
      <input type="text" class="form-control"  name="payment_method" required="required" placeholder="Enter payment method">
    </div>      
  </div>
  ...
  <div class="form-row" style="margin: 10px;">
   <div class="form-group col-md-12" style="">
      <label >payment method no.</label>
      <input type="text" class="form-control"  name="payment_method_no" required="required" placeholder="Enter payment method no.">
    </div>
  </div>
  ...
  <div class="form-row" style="margin: 10px;">
   <div class="form-group col-md-12" style="">
      ...
      <input type="text" class="form-control"  name="user_name" required="required" placeholder="Enter user name">
    </div>
  </div>
 ...
 <!--  <script src="vendor/jquery/jquery.min.js"></script>
  ...
  <script type="text/javascript">
     <?php include 'js/addpaymentmethod.js'; ?>
  </script>
