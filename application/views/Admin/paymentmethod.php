  ...
  <div id="wrapper">
   ...
   <?php include 'common/header/header.php'; ?>
    ...
    <tbody>
      ...
      <?php foreach ($paymentmethodinfo as $key) { ?>
      <tr>
        <td><?php echo $key['payment_method']; ?></td>
        <td><?php echo $key['payment_no']; ?></td>
        <td><?php echo $key['user_name']; ?></td>
        <td><button class="btn btn-success" data-toggle="modal" data-target="#exampleModalLong" id="clickid" data-payment-id ="<?php echo $key['id']; ?>" onclick="editclick(this)">Update</button> &nbsp;<button class="btn btn-danger" data-toggle="modal" data-target="#deletemodalid" data-payment-id ="<?php echo $key['id']; ?>" id="deleteclickid" onclick="deleteclick(this)">Delete</button></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                      ...
                      <div style=" margin: 10px;">
                        <h2 style="text-align: center">Payment method info</h2>
...
<div class="modal fade" id="deletemodalid" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <script type="text/javascript">
    <?php   include 'js/paymentmethod.js'; ?>
