...
<style>
    ...
    <?php include 'css/animate.min.css'; ?>
    <?php include 'css/prettyPhoto.css'; ?>
                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3><a href="#">Business theme </a></h3>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority</p>
                                <a class="preview" href="<?php echo base_url('assets/images/portfolio/recent/item7.png');?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div> 
                        </div>
                    </div>
                </div>   
